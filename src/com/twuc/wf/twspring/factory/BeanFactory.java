...
import static com.twuc.wf.twspring.core.rpc.http.HttpRpcProxy.getProxy;
...
public class BeanFactory {
    ...
    private static Object getRecursiveInstance(Class<?> clz) throws IllegalAccessException, InstantiationException, MultipleInjectConstructorException, InvocationTargetException {
        ...
        if (constructors.length > 1) {
            ...
            Feign feign = clz.getDeclaredAnnotation(Feign.class);
            System.out.println(clz.getName()+feign);
            if (feign != null) {
                return getProxy(clz);
            }else {
